...
// Create calendar
const dateCountdown = (0, _flatpickrDefault.default)("#datetime-picker", {
    enableTime: true,
    time_24hr: true,
    defaultDate: new Date(),
    minuteIncrement: 1,
    onClose (selectedDates) {
        if (selectedDates[0] <= new Date()) (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the future");
    }
});
// Set timer
